...
const CHANNELS_DATA: Channel[] = [
  ...
  { id: "alkass_direct", name: "Al Kass HD (Proxy)", url: "https://api.allorigins.win/raw?url=http://174.122.201.218:1935/dkass_hd/my1/playlist.m3u8", category: "Sports", icon: "🏆", quality: "HD" },
